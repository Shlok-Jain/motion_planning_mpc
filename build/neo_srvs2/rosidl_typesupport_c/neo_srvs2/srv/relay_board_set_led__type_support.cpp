...
static const _RelayBoardSetLED_Request_type_support_symbol_names_t _RelayBoardSetLED_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, neo_srvs2, srv, RelayBoardSetLED_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, neo_srvs2, srv, RelayBoardSetLED_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, neo_srvs2, srv, RelayBoardSetLED_Request)() {
  return &::neo_srvs2::srv::rosidl_typesupport_c::RelayBoardSetLED_Request_message_type_support_handle;
}
...
static const _RelayBoardSetLED_Response_type_support_symbol_names_t _RelayBoardSetLED_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, neo_srvs2, srv, RelayBoardSetLED_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, neo_srvs2, srv, RelayBoardSetLED_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, neo_srvs2, srv, RelayBoardSetLED_Response)() {
  return &::neo_srvs2::srv::rosidl_typesupport_c::RelayBoardSetLED_Response_message_type_support_handle;
}
...
static const _RelayBoardSetLED_type_support_symbol_names_t _RelayBoardSetLED_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, neo_srvs2, srv, RelayBoardSetLED)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, neo_srvs2, srv, RelayBoardSetLED)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, neo_srvs2, srv, RelayBoardSetLED)() {
  return &::neo_srvs2::srv::rosidl_typesupport_c::RelayBoardSetLED_service_type_support_handle;
}
